...
(function(factory) {
    ...
    methods = {
        ...
        destroy: function (options) {
            return this.each(function () {
                ...
                var input = _i(original);
                var wrapped_list = _getWrappedList(input, _uuid(input));
        ...
        */
        ...
        show: function (e) {
            return this.each(function () {
                ...
                else if (_uuid(_getWrappedList(undefined, uuid)) == uuid) {
                    dd('_getWrappedList(undefined, _uuid(input)).show()');
                    _getWrappedList(undefined, uuid).show();
                }
                else {
                    dd('_render');
                    _getWrappedList(input, uuid).show();
                    _dataRender(input);
                }
            });
        },
     ...
     * @private
     */
    function _getWrappedList(input, uuid) {
        if (typeof input != 'undefined') {
            uuid = _uuid(input);
        }
    ...
    function _setWrappedListWidthAndHeight(input) {
        var inputpicker_div = _getInputpickerDiv(input);
        var wrapped_list = _getWrappedList(undefined, _uuid(input));
    ...
    function _setWrappedListPosition(input) {
        ...
        _getWrappedList(input, _uuid(input)).css({
    ...
    function _getWrappedListElements(isActive) {
        ...
        return _getWrappedList(undefined, _uuid(input)).find(p);
    }

    // function _getWrappedListElement(i) {
    //     return _getWrappedList(undefined, _uuid(input)).find('inputpicker-element-' + i);
    // }
    //
    // function _getWrappedListSelectedElement() {
    //     return _getWrappedList(undefined, _uuid(input)).find('tr.selected');
    // }
