...
(function(factory) {
    ...
    function _getInputpickerDiv(input) {
        return _i(input).closest('.inputpicker-div-'+_uuid(input));
    ...
    function _getWrappedList(input) {
        ...
        var wrapped_list = $('div#inputpicker-wrapped-list-'+window.ipu);
        if ( ! wrapped_list.length){
            wrapped_list = $('<div />', {
                id: 'inputpicker-wrapped-list-'+window.ipu,
                tabindex: -1
            }).css({
                'display':'none',
                'position': 'absolute',
            ...
            .appendTo('#inputpicker-div-'+window.ipu); // modified by me
    ...
    function _dataRenderMultiple(input){
        ...
        wrapped_list.find('tbody').find('tr').each(function () {
            ...
            that.on('mouseover', function (e) {
                ...
                var self = $(this);
                var uuid = $('div#inputpicker-wrapped-list').data('inputpicker-uuid') ;
