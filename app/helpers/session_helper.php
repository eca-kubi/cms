...
function flash($name = 'flash', $message = '', $class = 'alert alert-success alert-dismissible', $dismissible_button = '<button type="button" class="close" data-dismiss="alert" style="position: absolute;top: 10%;left: 95%;" aria-label="Close">
