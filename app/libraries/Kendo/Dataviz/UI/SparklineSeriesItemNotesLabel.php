...
class SparklineSeriesItemNotesLabel extends \Kendo\SerializableObject {
//>> Properties

    /**
    * The background color of the label. Accepts a valid CSS color string, including hex and rgb.
    * @param string $value
    * @return \Kendo\Dataviz\UI\SparklineSeriesItemNotesLabel
    */
    ...
    * @param \Kendo\Dataviz\UI\SparklineSeriesItemNotesLabelBorder|array $value
    * @return \Kendo\Dataviz\UI\SparklineSeriesItemNotesLabel
    */
    ...
    */
    ...
    /**
    * Sets the template option of the SparklineSeriesItemNotesLabel.
