...
class ChartSeriesDefaultsNotesLabel extends \Kendo\SerializableObject {
//>> Properties

    /**
    * The background color of the label. Accepts a valid CSS color string, including hex and rgb.
    * @param string $value
    * @return \Kendo\Dataviz\UI\ChartSeriesDefaultsNotesLabel
    */
    ...
    * @param \Kendo\Dataviz\UI\ChartSeriesDefaultsNotesLabelBorder|array $value
    * @return \Kendo\Dataviz\UI\ChartSeriesDefaultsNotesLabel
    */
    ...
    */
    ...
    /**
    * Sets the template option of the ChartSeriesDefaultsNotesLabel.
