...
class ChartSeriesItemNotesIcon extends \Kendo\SerializableObject {
//>> Properties

    /**
    * The background color of the notes icon.
    * @param string $value
    * @return \Kendo\Dataviz\UI\ChartSeriesItemNotesIcon
    */
    ...
    * @param \Kendo\Dataviz\UI\ChartSeriesItemNotesIconBorder|array $value
    * @return \Kendo\Dataviz\UI\ChartSeriesItemNotesIcon
    */
