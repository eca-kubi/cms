...
class ChartXAxisItemNotesLabel extends \Kendo\SerializableObject {
//>> Properties

    /**
    * The background color of the label. Accepts a valid CSS color string, including hex and rgb.
    * @param string $value
    * @return \Kendo\Dataviz\UI\ChartXAxisItemNotesLabel
    */
    ...
    * @param \Kendo\Dataviz\UI\ChartXAxisItemNotesLabelBorder|array $value
    * @return \Kendo\Dataviz\UI\ChartXAxisItemNotesLabel
    */
    ...
    */
    ...
    /**
    * Sets the template option of the ChartXAxisItemNotesLabel.
