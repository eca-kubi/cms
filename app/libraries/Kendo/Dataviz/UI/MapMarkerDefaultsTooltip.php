...
class MapMarkerDefaultsTooltip extends \Kendo\SerializableObject {
//>> Properties

    /**
    * Specifies if the tooltip will be hidden when mouse leaves the target element. If set to false a close button will be shown within tooltip. If set to false, showAfter is specified and the showOn is set to "mouseenter" the Tooltip will be displayed after the given timeout even if the element is no longer hovered.
    * @param boolean $value
    * @return \Kendo\Dataviz\UI\MapMarkerDefaultsTooltip
    */
    ...
    * @param \Kendo\Dataviz\UI\MapMarkerDefaultsTooltipAnimation|array $value
    * @return \Kendo\Dataviz\UI\MapMarkerDefaultsTooltip
    */
    ...
    * @param string|\Kendo\JavaScriptFunction|\Kendo\Dataviz\UI\MapMarkerDefaultsTooltipContent|array $value
    * @return \Kendo\Dataviz\UI\MapMarkerDefaultsTooltip
    */
    ...
    /**
    * Sets the template option of the MapMarkerDefaultsTooltip.
