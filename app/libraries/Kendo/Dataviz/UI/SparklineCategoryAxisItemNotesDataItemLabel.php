...
class SparklineCategoryAxisItemNotesDataItemLabel extends \Kendo\SerializableObject {
//>> Properties

    /**
    * The background color of the label. Accepts a valid CSS color string, including hex and rgb.
    * @param string $value
    * @return \Kendo\Dataviz\UI\SparklineCategoryAxisItemNotesDataItemLabel
    */
    ...
    * @param \Kendo\Dataviz\UI\SparklineCategoryAxisItemNotesDataItemLabelBorder|array $value
    * @return \Kendo\Dataviz\UI\SparklineCategoryAxisItemNotesDataItemLabel
    */
    ...
    */
    ...
    /**
    * Sets the template option of the SparklineCategoryAxisItemNotesDataItemLabel.
