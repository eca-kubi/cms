...
class SparklineValueAxisItemNotesDataItemLabel extends \Kendo\SerializableObject {
//>> Properties

    /**
    * The background color of the label. Accepts a valid CSS color string, including hex and rgb.
    * @param string $value
    * @return \Kendo\Dataviz\UI\SparklineValueAxisItemNotesDataItemLabel
    */
    ...
    * @param \Kendo\Dataviz\UI\SparklineValueAxisItemNotesDataItemLabelBorder|array $value
    * @return \Kendo\Dataviz\UI\SparklineValueAxisItemNotesDataItemLabel
    */
    ...
    */
    ...
    /**
    * Sets the template option of the SparklineValueAxisItemNotesDataItemLabel.
