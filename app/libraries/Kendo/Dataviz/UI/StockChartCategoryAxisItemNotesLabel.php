...
class StockChartCategoryAxisItemNotesLabel extends \Kendo\SerializableObject {
//>> Properties

    /**
    * The background color of the label. Accepts a valid CSS color string, including hex and rgb.
    * @param string $value
    * @return \Kendo\Dataviz\UI\StockChartCategoryAxisItemNotesLabel
    */
    ...
    * @param \Kendo\Dataviz\UI\StockChartCategoryAxisItemNotesLabelBorder|array $value
    * @return \Kendo\Dataviz\UI\StockChartCategoryAxisItemNotesLabel
    */
    ...
    */
    ...
    /**
    * Sets the template option of the StockChartCategoryAxisItemNotesLabel.
