...
class ChartCategoryAxisItemNotesDataItemLabel extends \Kendo\SerializableObject {
//>> Properties

    /**
    * The background color of the label. Accepts a valid CSS color string, including hex and rgb.
    * @param string $value
    * @return \Kendo\Dataviz\UI\ChartCategoryAxisItemNotesDataItemLabel
    */
    ...
    * @param \Kendo\Dataviz\UI\ChartCategoryAxisItemNotesDataItemLabelBorder|array $value
    * @return \Kendo\Dataviz\UI\ChartCategoryAxisItemNotesDataItemLabel
    */
    ...
    */
    ...
    /**
    * Sets the template option of the ChartCategoryAxisItemNotesDataItemLabel.
