...
class ChartCategoryAxisItemNotesLabel extends \Kendo\SerializableObject {
//>> Properties

    /**
    * The background color of the label. Accepts a valid CSS color string, including hex and rgb.
    * @param string $value
    * @return \Kendo\Dataviz\UI\ChartCategoryAxisItemNotesLabel
    */
    ...
    * @param \Kendo\Dataviz\UI\ChartCategoryAxisItemNotesLabelBorder|array $value
    * @return \Kendo\Dataviz\UI\ChartCategoryAxisItemNotesLabel
    */
    ...
    */
    ...
    /**
    * Sets the template option of the ChartCategoryAxisItemNotesLabel.
