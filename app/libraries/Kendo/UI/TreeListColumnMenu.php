...
//>> Properties
    ...
    */
    ...
    /**
    * If set to true the column menu will allow the user to filter the TreeList. By default the column menu allows the user to filter if filtering is enabled via the filterable.
    * @param boolean $value
    * @return \Kendo\UI\TreeListColumnMenu
    */
