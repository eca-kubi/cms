                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group form-row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="file" name="risk_attachment" aria-describedby="helpId"
                    ...
                    <div class="col-sm-12">
                        <div class="form-group form-row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select class="form-control bs-select multiple-hidden d-none" name="affected_dept[]"
                                        aria-describedby="helpId" data-none-selected-text="Select Affected Departments"
                                        multiple="multiple">
...
<?php
} else if (!empty($payload['form']->affected_dept)) {
    ?>
    <div class="row p-2">
        <div class="w-100">
        <span class="row w-100 border ml-0 p-1">
       ...
       <?php
} else if (empty($payload['form']->affected_dept) && !isOriginator($payload['form']->cms_form_id, getUserSession()->user_id)) {
