...
<style>
    ...
    #action_list_closure tr:not(.child) {
        counter-increment: rowNumber;
    }

        #action_list_closure tr:not(.child) td:first-child::before {
            content: counter(rowNumber);
            min-width: 1em;
            margin-right: 0.5em;
            margin-left: 0.5em;
                ...
                <form action="" method="post">
                    <div class="row p-2">
                        <h6 class="text-bold font-italic">
                            <a href="#section_1" data-toggle="collapse">
                                ...
                                <span class="text-muted display-sm-inline d-block">(Completed by - Originator)</span>
                            </a>
                        </h6>
                    ...
                    <div class="row p-2">
                        <h6 class="text-bold font-italic">
                            ...
                            <span class="text-muted">(Completed by Project Leader)</span>
                        </h6>
                        <div class="col-sm-12 collapse section" id="section_6">
                            <table class="table table-user-information font-raleway" id="action_list_closure">
                                <thead class="thead-default">
                                    <tr>
                                        <th>No.</th>
                    ...
                    <div class="row p-2">
                        <h6 class="text-bold font-italic">
                            <a href="#section_7" data-toggle="collapse">
                                <i class="fa fa-minus"></i> Section 7 - Process Closure by Project Leader, HOD & Originator
                            </a>
                        </h6>
                        <div class="col-sm-12 section collapse show" id="section_7">
                            <div class="w-100">
                                <table class="table table-user-information font-raleway">
                                    <thead class="thead-default">
                                        <tr>
