                        ...
                        <fieldset class="w-100">
                            <h6 class="text-bold font-italic">
                                <a href="#section_5" data-toggle="collapse">
                                    <i class="fa fa-minus" data-id></i> Section 5 - Authorisation by HOD to Implement Change
                                    and Project Leader Acceptance
                                </a>
                            </h6>
                            <div id="section_5" class="collapse show section">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table class="table table-user-information font-raleway">
                                            <thead class="thead-default d-none">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group form-row">
                                            <label for="" class="col-sm-12">Project Leader's Comments</label>
                                            <div class="col-sm-8">
                                                <textarea
                                    ...
                                    <div class="col-sm-8 text-right">
                                        <button type="submit" class="btn bg-success w3-btn">Accept</button>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
